# Track A — #100DaysOfAzureDevOps LinkedIn
...
Personal account, personal time, personal Azure. No employer, no clients, no work laptop.
...
3. Attach the day PDF from `days/day-NN-*/handout.pdf`. After upload, paste that day's **Document title** (max 58 chars). Full list: [`100-days-document-titles.md`](./100-days-document-titles.md). The post body must include `Lab notes + PDF: https://github.com/muthusethu/azure-tutorial/tree/main/days/day-NN-…`.
