...
1. Push sanitized capstone to personal GitHub
2. README: problem, architecture, how to run, screenshots
...
```
Day 94 of #100DaysOfAzureDevOps

GitHub is your shop window - pinned repos with vague names are closed blinds

Today's topic: **GitHub Portfolio Setup**.

I am learning in public for 100 days - mistakes included, sales pitches not included.

Tomorrow: Personal site / case studies.
...
| **Copy** | This file — LinkedIn section | [`publish/production-grade/notes.md`](../publish/production-grade/notes.md) — Note 31 |
| **Attach** | Day PDF when ready | None (story post) |

- [ ] Post 1 — daily lesson (+ PDF)
- [ ] Post 2 — production note 31 of 33 (rewrite with your real experience)
